...
Details: [AST Utils module](https://github.com/GufNZ/JaiModules-AST_Utils).
...
The sizes available and the number of each is controlled with the SIZES_CONFIG parameter - see below.
Everything is dynamically created off this config, so there's no waste.

Details: [Bucket Allocator module](https://github.com/GufNZ/JaiModules-Bucket_Allocator).
